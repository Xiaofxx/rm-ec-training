...
- [知乎](https://www.zhihu.com) — 适合找经验帖，如"STM32 怎么入门""大一如何加入机器人战队"。
...
- [GitHub](https://github.com) — 搜索技巧：`关键词 + 芯片型号`，按 Star 排序看高口碑工程，例如 [STM32 OLED 搜索结果](https://github.com/search?q=STM32+OLED&type=repositories)。
...
经典书籍（如《C 和指针》）的电子版可通过 Zlibrary 获取。该站域名时常更换，直接搜索"Zlibrary"或其镜像站即可；条件允许建议支持纸质正版。

## 待补充

- [ ] 队内网盘资料汇总（历年例程、工具安装包）
- [ ] 常用软件下载清单（Keil、CubeMX、串口助手等版本统一）
