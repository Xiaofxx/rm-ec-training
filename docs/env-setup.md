...
这些或许是你们将来可能会用到的软件（仅举例，<u>具体要配置哪些见后续章节</u>），总而言之，配置软件以及一些环境或许是最基础也是最容易难倒初学者的第一关

---

请先阅读本站的[软件作用与配置顺序](software-setup-order.md)，再按照侧边栏“开发环境配置图文详解”中的对应教程下载安装和配置软件。

==注意原则：任何软件，都是优先到官网下载安装！！！==
>这里考虑到大家是初学者，方便起见，我们下载并整理了开发过程中常用的软件安装包，放在群文件**software**压缩包中，可以自行下载，亦可通过[百度网盘链接](https://pan.baidu.com/s/1PLoIJmeH33LL_dX_05VRsg?pwd=vc2z)进行下载。


**在浏览器（推荐Edge或者chrome，用bing搜索引擎~~别用百度。。~~）搜索对应的你想要的软件名称，到官网下载界面选择windows64位(根据你的系统环境)的版本即可，一般会获得一个exe文件，打开根据指引安装即可**

也可以在B站搜索你想要的具体的某一款软件的安装教程



上述官网方式能解决98%的软件需求，如不能，看下方：
